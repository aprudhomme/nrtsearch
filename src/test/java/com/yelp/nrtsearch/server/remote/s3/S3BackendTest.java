...
public class S3BackendTest {
  ...
  public void testExists_globalState() throws IOException {
    ...
    assertTrue(s3Backend.exists("global_exist_service", null, IndexResourceType.GLOBAL_STATE));
    assertFalse(s3Backend.exists("global_exist_service_2", null, IndexResourceType.GLOBAL_STATE));
  }
