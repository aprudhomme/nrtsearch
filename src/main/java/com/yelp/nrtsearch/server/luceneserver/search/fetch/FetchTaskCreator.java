 ...
 * com.yelp.nrtsearch.server.luceneserver.search.fetch.FetchTasks.FetchTask}s.
 */
public class FetchTaskCreator {
  ...
  /**
   * Create a {@link com.yelp.nrtsearch.server.luceneserver.search.fetch.FetchTasks.FetchTask}
   * instance given the {@link FetchTask} message from the {@link
   * com.yelp.nrtsearch.server.grpc.SearchRequest}.
   *
   * @param grpcFetchTask task definition message
   * @return {@link com.yelp.nrtsearch.server.luceneserver.search.fetch.FetchTasks.FetchTask}
   *     instance
   */
